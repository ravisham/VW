...
$dockerTag  = 'stage-visionwheel-admin-site'; # docker image to deploy
$dockerService = 'stage-visionwheel-admin'; # service to deploy as
...
$deployURL    = "https://stage-shop.visionwheel.com:8443";
