...
exports.update = function update(callback) {
	...
	fs.readFile(exports.before, 'utf8', function reading(err, before) {
        ...
        request.get(exports.remote).end(function(err, res) {
            if (err) return callback(err);
...
exports.generate = function generate(results, callback) {
	var regexps = [
		'"use strict";', exports.LEADER, 'var parser;', 'exports.browser = Object.create(null);', results.user_agent_parsers.join('\n'), 'exports.browser.length = ' + results.user_agent_parsers.length + ';'
        , 'exports.device = Object.create(null);', results.device_parsers.join('\n'), 'exports.device.length = ' + results.device_parsers.length + ';'
		, 'exports.os = Object.create(null);', results.os_parsers.join('\n'), 'exports.os.length = ' + results.os_parsers.length + ';'
	].join('\n\n');
 ...
 * @api private
 */
exports.output = path.resolve(__dirname, 'regexps.js');