/**
 * Configuration.
 *https://raw.githubusercontent.com/pedroetb/node-oauth2-server-example/master/model.js
 */

var config = {
	clients: [{
		id: 'application',	// TODO: Needed by refresh_token grant, because there is a bug at line 103 in https://github.com/oauthjs/node-oauth2-server/blob/v3.0.1/lib/grant-types/refresh-token-grant-type.js (used client.id instead of client.clientId)
		clientId: 'loIzZMkzxgJiEvuy',
		clientSecret: 'prqoCHujIVVBqOKN',
		grants: [
			'password',
			'refresh_token',
            'client_credentials'
	...
	tokens: [],
	//users: [{
	//	username: 'dummy-client-id',
	//	password: 'dummy-client-secret'
	//}]
};
