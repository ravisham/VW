...
$dockerTag  = 'om-dev-visionwheel-shop'; # docker image to deploy
$dockerService = 'om-dev-visionwheel-shop'; # service to deploy as
...
$deployURL    = "https://om-dev-shop.visionwheel.com/";
