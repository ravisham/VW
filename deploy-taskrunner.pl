...
$dockerTag  = 'visionwheel-taskrunner'; # docker image to deploy
$dockerService = 'visionwheel-taskrunner'; # service to deploy as
...
$deployURL    = "https://shop.visionwheel.com:8080";
...
runCmd( "$dockerCmd build -f taskrunner/Dockerfile -t $dockerTag ." , $verbose );
